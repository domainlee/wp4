...
function ambrox_faIconFont() {
  ...
  wp_enqueue_style( 'font-awesome', CRTHEME_DIR_CSS_URI.'font-awesome.min.css', array(), '4.7.0', 'all' );
  
  // Redux admin css enqueue
  wp_enqueue_style( 'ambrox-redux-admin', CRTHEME_DIR_URI.'inc/redux-custom-field/assets/ambrox.redux.admin.css', array(), '1.0' );
  
  // Redux admin js enqueue
  wp_enqueue_script( 'ambrox-redux-admin', CRTHEME_DIR_URI.'inc/redux-custom-field/assets/ambrox.redux.admin.js', array( 'jquery' ), '1.0', true );
